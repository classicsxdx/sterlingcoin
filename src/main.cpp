...
static unsigned int GetNextTargetRequired_(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    // Includes sterlingcoin fix for wrong retargeting difficulty by Mammix2
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "sterlingcoin, just sterling along the long road of cryptos";
        CTransaction txNew;
        txNew.nTime = 1403128231;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("16b9d05f5f24988df5bbcc7a212100aebceb219ac6dc539cf2549fe94f2803ba"));
        block.print();
